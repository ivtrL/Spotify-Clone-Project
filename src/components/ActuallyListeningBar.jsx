    ...
    <div className='listening-bar'>
      <div className="listening-bar-container">
        ...
        <div className="controller-menu">
          <Stack className='buttons' direction="row" spacing={3} alignItems='center'>
            <a href="#" className="skip-button">
            <SkipPreviousIcon/>
            </a>
            <a href="#" className="play-pause-button" onClick={() => {iconPlay ? setIconPlay(false): setIconPlay(true)}}>
          ...
          <Stack className='song-progress-bar' direction="row" spacing={2} alignItems='center'>
            <p className='actual-time-song'>{songTimeValue}</p>
            <Slider size='small' sx={{color: 'white'}} max={maxTimeSong} value={songTimeValue} onChange={handleSongTimeChange} aria-label="Default" valueLabelDisplay='off'/>
        ...
        <div className='volume-bar'>
          <Stack direction="row" spacing={2}>
            ...
            <Slider size='small' sx={{color: 'white'}} value={value} onChange={handleChange} aria-label="Volume" valueLabelDisplay='auto'/>
          </Stack>
        </div>
      </div>
    </div>
